...
%% Modified by Mariana Ferreira Rocha - 10/06/2019 %%
...
\cvsection{Educação}
\cvevent{Graduanda no Curso de Ciência da Computação}{Universidade Federal do Espírito Santo (UFES) \newline Centro Universitário Norte do Espírito Santo (Ceunes)}{}{}
% \divider
...
\smallskip
%\divider
\cvskill{C++, Java, Python, Git}{3}
\smallskip
% \divider
\cvskill{HTML 5, CSS 3, JavaScript}{3}
\smallskip
% \divider
\cvskill{Git}{2}
% \divider
